...
<body>
	<div class="container-fluid">
		...
		<header>
			...
			<!-- 						<li class="nav-item"><a class="nav-link" href="depart/listDepart">Depart</a> -->
			<!-- 						</li> -->
		...
		<main class="container">
			<div style="margin-top: 100px;" class="card card-primary">
				<div style="background: #57b846;" class="card-header">
					<h3 class="card-title">List Depart</h3>
				</div>
				<!-- /.card-header -->
				<!-- form start -->
				<div class="card-body">
							...
							<tbody>
								...
								<c:forEach var="d" items="${listDepart}">
									<tr>
										...
										<td>${d.id }</td>
										<td>${d.name }</td>
										<td><a href="/depart/update/${d.id }"
											class="btn btn-primary" type="button">Update</a></td>
										<td><a href="/depart/delete/${d.id }"
