	...
	<div class="container-fluid">
		...
		<main class="container">
			...
			<div style="margin-top: 100px;" class="card card-primary">
				...
				<!-- /.card-header -->
				<!-- form start -->
				<form:form action="/user/insert" modelAttribute="user" method="post">
					<div class="card-body">
						...
						<div class="form-group">
							...
							<br>
							<form:errors path="fullname" id="fullnameerror" style="color:red;" />
						</div>
					</div>
					<!-- /.card-body -->
					...
					<div class="card-footer">
						...
						<a href="/user/" class="btn btn-primary" id="listUser">List User</a>
					</div>
				</form:form>
			</div>
		</main>
